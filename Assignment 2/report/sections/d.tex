...
The compressed timing diagram is shown in Table~\ref{tab:d}. The compressed timing diagram is also included in the submission as 4DM4-Assignment-\#2d-Compressed-Timing-Table-single-issue.xlsx. The performance, or MFLOP rating, of the implementation with a 3 GHz clock is (3 GHz)*(8 FLOP/24 cc) = 1000 MFLOP/s.
